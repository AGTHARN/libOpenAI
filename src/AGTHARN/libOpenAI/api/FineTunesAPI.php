...
class FineTunesAPI
{
    ...
    public static function retrieve(
        ...
        return Helper::sendRequest('GET', $apiKey, '', self::API_V1 . '/' . $fine_tune_id, $callback);
    }
    ...
    public static function cancel(
        ...
        return Helper::sendRequest('POST', $apiKey, '', self::API_V1 . '/' . $fine_tune_id . '/cancel', $callback);
    }
    ...
    public static function listEvents(
        ...
        return Helper::sendRequest('GET', $apiKey, '', self::API_V1. '/' . $fine_tune_id . '/events', $callback);
    }
